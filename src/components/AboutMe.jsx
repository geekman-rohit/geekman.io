  ...
  return (
    <Container>
      ...
      <Paragraph>
        ...
        These days, you can find me working at <strong>Flipkart</strong>, building features for the fast, light and <strong>cross-platform</strong> Flipkart app used by 200 million+ users.
      </Paragraph>
    </Container>
  );
}